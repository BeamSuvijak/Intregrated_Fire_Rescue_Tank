...
while running:
    ...
    motor = [0,0]
    if(inn(pressed_keys,W,A)): motor = [1,0]
    elif(inn(pressed_keys,W,D)): motor = [0,1]
    elif(inn(pressed_keys,S,A)): motor = [-1,0]
    elif(inn(pressed_keys,S,D)): motor = [0,-1]
    ...
    gpio.output(soli,inn(pressed_keys,space))
